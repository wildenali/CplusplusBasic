#include <iostream>
#include <string>
#include <stdlib.h>     // untuk memanggil fungsi system("clear")
#include <fstream>
...
void checkDatabase(fstream &data){
    data.open("aq_02_data.bin", ios::out | ios::in | ios::binary);
    ...
    if(data.is_open()){
        ...
        data.close();
        data.open("aq_02_data.bin", ios::trunc | ios::out | ios::in | ios::binary);
    }
}
